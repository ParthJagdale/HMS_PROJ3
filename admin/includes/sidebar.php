 <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.php" class="brand-link" style="font-weight:bold; font-size:22px;">
      ...
      <span class="brand-text font-weight-light">HMS | Admin</span>
    </a>
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="blood/addccc.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Bloodbank</p>
                </a>
              </li>
           ...
           <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="bed/addccc.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Bed</p>
                </a>
              </li>
           ...
           <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="ambulance/addccc.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Ambulance</p>
                </a>
              </li>
